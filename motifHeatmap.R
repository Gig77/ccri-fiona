...
names(at2)[names(at2) %in% c("Motif Name", "P-value", "q-value (Benjamini)", "% of Target Sequences with Motif", "% of Background Sequences with Motif")] <- c("motif", "p.at2", "q.at2", "freq.at2", "freq.at2.bg")
at2$freq.at2 <- as.numeric(gsub("%", "", at2$freq.at2))
at2$freq.at2.bg <- as.numeric(gsub("%", "", at2$freq.at2.bg))
at2 <- at2[!duplicated(at2$motif),]

names(at2.unique)[names(at2.unique) %in% c("Motif Name", "P-value", "q-value (Benjamini)", "% of Target Sequences with Motif", "% of Background Sequences with Motif")] <- c("motif", "p.at2.unique", "q.at2.unique", "freq.at2.unique", "freq.at2.unique.bg")
at2.unique$freq.at2.unique <- as.numeric(gsub("%", "", at2.unique$freq.at2.unique))
at2.unique$freq.at2.unique.bg <- as.numeric(gsub("%", "", at2.unique$freq.at2.unique.bg))
at2.unique <- at2.unique[!duplicated(at2.unique$motif),]

names(at2.shared)[names(at2.shared) %in% c("Motif Name", "P-value", "q-value (Benjamini)", "% of Target Sequences with Motif", "% of Background Sequences with Motif")] <- c("motif", "p.at2.shared", "q.at2.shared", "freq.at2.shared", "freq.at2.shared.bg")
at2.shared$freq.at2.shared <- as.numeric(gsub("%", "", at2.shared$freq.at2.shared))
at2.shared$freq.at2.shared.bg <- as.numeric(gsub("%", "", at2.shared$freq.at2.shared.bg))
at2.shared <- at2.shared[!duplicated(at2.shared$motif),]

names(reh)[names(reh) %in% c("Motif Name", "P-value", "q-value (Benjamini)", "% of Target Sequences with Motif", "% of Background Sequences with Motif")] <- c("motif", "p.reh", "q.reh", "freq.reh", "freq.reh.bg")
reh$freq.reh <- as.numeric(gsub("%", "", reh$freq.reh))
reh$freq.reh.bg <- as.numeric(gsub("%", "", reh$freq.reh.bg))
reh <- reh[!duplicated(reh$motif),]

names(reh.unique)[names(reh.unique) %in% c("Motif Name", "P-value", "q-value (Benjamini)", "% of Target Sequences with Motif", "% of Background Sequences with Motif")] <- c("motif", "p.reh.unique", "q.reh.unique", "freq.reh.unique", "freq.reh.unique.bg")
reh.unique$freq.reh.unique <- as.numeric(gsub("%", "", reh.unique$freq.reh.unique))
reh.unique$freq.reh.unique.bg <- as.numeric(gsub("%", "", reh.unique$freq.reh.unique.bg))
reh.unique <- reh.unique[!duplicated(reh.unique$motif),]

names(reh.shared)[names(reh.shared) %in% c("Motif Name", "P-value", "q-value (Benjamini)", "% of Target Sequences with Motif", "% of Background Sequences with Motif")] <- c("motif", "p.reh.shared", "q.reh.shared", "freq.reh.shared", "freq.reh.shared.bg")
reh.shared$freq.reh.shared <- as.numeric(gsub("%", "", reh.shared$freq.reh.shared))
reh.shared$freq.reh.shared.bg <- as.numeric(gsub("%", "", reh.shared$freq.reh.shared.bg))
reh.shared <- reh.shared[!duplicated(reh.shared$motif),]

names(nalm6.er)[names(nalm6.er) %in% c("Motif Name", "P-value", "q-value (Benjamini)", "% of Target Sequences with Motif", "% of Background Sequences with Motif")] <- c("motif", "p.nalm6.er", "q.nalm6.er", "freq.nalm6.er", "freq.nalm6.er.bg")
nalm6.er$freq.nalm6.er <- as.numeric(gsub("%", "", nalm6.er$freq.nalm6.er))
nalm6.er$freq.nalm6.er.bg <- as.numeric(gsub("%", "", nalm6.er$freq.nalm6.er.bg))
nalm6.er <- nalm6.er[!duplicated(nalm6.er$motif),]

names(nalm6.er.unique)[names(nalm6.er.unique) %in% c("Motif Name", "P-value", "q-value (Benjamini)", "% of Target Sequences with Motif", "% of Background Sequences with Motif")] <- c("motif", "p.nalm6.er.unique", "q.nalm6.er.unique", "freq.nalm6.er.unique", "freq.nalm6.er.unique.bg")
nalm6.er.unique$freq.nalm6.er.unique <- as.numeric(gsub("%", "", nalm6.er.unique$freq.nalm6.er.unique))
nalm6.er.unique$freq.nalm6.er.unique.bg <- as.numeric(gsub("%", "", nalm6.er.unique$freq.nalm6.er.unique.bg))
nalm6.er.unique <- nalm6.er.unique[!duplicated(nalm6.er.unique$motif),]

names(nalm6.er.shared)[names(nalm6.er.shared) %in% c("Motif Name", "P-value", "q-value (Benjamini)", "% of Target Sequences with Motif", "% of Background Sequences with Motif")] <- c("motif", "p.nalm6.er.shared", "q.nalm6.er.shared", "freq.nalm6.er.shared", "freq.nalm6.er.shared.bg")
nalm6.er.shared$freq.nalm6.er.shared <- as.numeric(gsub("%", "", nalm6.er.shared$freq.nalm6.er.shared))
nalm6.er.shared$freq.nalm6.er.shared.bg <- as.numeric(gsub("%", "", nalm6.er.shared$freq.nalm6.er.shared.bg))
nalm6.er.shared <- nalm6.er.shared[!duplicated(nalm6.er.shared$motif),]

names(nalm6.runx1)[names(nalm6.runx1) %in% c("Motif Name", "P-value", "q-value (Benjamini)", "% of Target Sequences with Motif", "% of Background Sequences with Motif")] <- c("motif", "p.nalm6.runx1", "q.nalm6.runx1", "freq.nalm6.runx1", "freq.nalm6.runx1.bg")
nalm6.runx1$freq.nalm6.runx1 <- as.numeric(gsub("%", "", nalm6.runx1$freq.nalm6.runx1))
nalm6.runx1$freq.nalm6.runx1.bg <- as.numeric(gsub("%", "", nalm6.runx1$freq.nalm6.runx1.bg))
nalm6.runx1 <- nalm6.runx1[!duplicated(nalm6.runx1$motif),]

combined <- at2[,c("motif", "p.at2", "q.at2", "freq.at2", "freq.at2.bg")]
combined <- merge(combined, reh[,c("motif", "p.reh", "q.reh", "freq.reh", "freq.reh.bg")], all=T)
combined <- merge(combined, nalm6.er[,c("motif", "p.nalm6.er", "q.nalm6.er", "freq.nalm6.er", "freq.nalm6.er.bg")], all=T)
combined <- merge(combined, nalm6.runx1[,c("motif", "p.nalm6.runx1", "q.nalm6.runx1", "freq.nalm6.runx1", "freq.nalm6.runx1.bg")], all=T)
combined <- merge(combined, at2.unique[,c("motif", "p.at2.unique", "q.at2.unique", "freq.at2.unique", "freq.at2.unique.bg")], all=T)
combined <- merge(combined, reh.unique[,c("motif", "p.reh.unique", "q.reh.unique", "freq.reh.unique", "freq.reh.unique.bg")], all=T)
combined <- merge(combined, nalm6.er.unique[,c("motif", "p.nalm6.er.unique", "q.nalm6.er.unique", "freq.nalm6.er.unique", "freq.nalm6.er.unique.bg")], all=T)
combined <- merge(combined, at2.shared[,c("motif", "p.at2.shared", "q.at2.shared", "freq.at2.shared", "freq.at2.shared.bg")], all=T)
combined <- merge(combined, reh.shared[,c("motif", "p.reh.shared", "q.reh.shared", "freq.reh.shared", "freq.reh.shared.bg")], all=T)
combined <- merge(combined, nalm6.er.shared[,c("motif", "p.nalm6.er.shared", "q.nalm6.er.shared", "freq.nalm6.er.shared", "freq.nalm6.er.shared.bg")], all=T)
rownames(combined) <- combined$motif

write.table(combined, "/mnt/projects/fiona/results/motifHeatmap.combinedData.tsv", col.names = T, row.names = F, sep = "\t", quote = F)
