...
pdf ("/mnt/projects/fiona/results/peak-distance-to-TSS.pdf", width=8, height=8)
par(mfrow=c(2,2))
...
legend("topright", c("E/R", "RUNX1", "random"), fill=c("blue", "red", "lightgray"), cex=1.4)
...
legend("topright", c("shared", "unique", "random"), fill=c("blue", "red", "lightgray"), cex=1.4)
...
lines(density(at2$`Distance to TSS`[unique(o.at2.nalm6.runx1@queryHits)]/1000, n=5000, bw=3), col="blue", lwd=4)
lines(density(at2$`Distance to TSS`[-unique(o.at2.nalm6.runx1@queryHits)]/1000, n=5000, bw=3), col="red", lwd=4)
legend("topright", c("shared", "unique", "random"), fill=c("blue", "red", "lightgray"), cex=1.4)
...
polygon(density(reh.shuffled$`Distance to TSS`/1000, n=5000, bw=3), col="lightgray", border="lightgray")
lines(density(reh$`Distance to TSS`[unique(o.reh.nalm6.runx1@queryHits)]/1000, n=5000, bw=3), col="blue", lwd=4)
lines(density(reh$`Distance to TSS`[-unique(o.reh.nalm6.runx1@queryHits)]/1000, n=5000, bw=3), col="red", lwd=4)
legend("topright", c("shared", "unique", "random"), fill=c("blue", "red", "lightgray"), cex=1.4)
...
legend("topright", c("shared with REH", "only AT2"), fill=c("blue", "red"), cex=1.4)
...
legend("topright", c("shared with AT2", "only REH"), fill=c("blue", "red"), cex=1.4)

# E/R NALM6 vs AT2/REH
...
legend("topright", c("NALM6", "REH", "AT2", "random"), fill=c("black", "red", "blue", "lightgray"), cex=1.4)
...
legend("topright", c(paste0("Peak score <= ", score.cutoff), paste0("Peak score > ", score.cutoff)), fill=c("blue", "red"), cex=1.4)
